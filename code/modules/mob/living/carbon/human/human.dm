	...
	if (href_list["flavor_change"])
		switch(href_list["flavor_change"])
			if("done")
				...
				return
			if("general")
				var/msg = sanitize_paper(input(usr,"Update the general description of your character. This will be shown regardless of clothing, and may include OOC notes and preferences.","Flavor Text", null) as message)
				//if(msg != null)
				...
				var/msg = sanitize_paper (input(usr,"Update the flavor text for your [href_list["flavor_change"]].","Flavor Text", null) as message)
				//if(msg != null)
					//msg = copytext(msg, 1, MAX_MESSAGE_LEN)
					//msg = html_encode(msg)
				flavor_texts[href_list["flavor_change"]] = msg
