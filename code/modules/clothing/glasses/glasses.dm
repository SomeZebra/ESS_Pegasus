...
/obj/item/clothing/glasses/meson/eyepatch/attack_self(mob/user)
	if(toggleable)
		if(active)
			active = 0
			icon_state = "eyepatch"
...
/obj/item/clothing/glasses/meson/eyepatch
	name = "Eyepatch Meson Scanner"
	desc = "Meson Scanner conneting to the optic nerve of the right eye."
	icon_state = "eyepatch"
