...
var/list/ai_status_emotions = list(
	...
	"SW Awesome"				= new /datum/ai_emotion("ai_sw_awesome"),
	"SW Confused"				= new /datum/ai_emotion("ai_sw_confused"),
	"SW Facehoof"				= new /datum/ai_emotion("ai_sw_facehoof"),
	"SW Happy"					= new /datum/ai_emotion("ai_sw_happy"),
	"SW Neutral"				= new /datum/ai_emotion("ai_sw_neutral"),
	"SW Sad"					= new /datum/ai_emotion("ai_sw_sad"),
	"SW Surprised"				= new /datum/ai_emotion("ai_sw_surprised"),
	"SW Trollface"				= new /datum/ai_emotion("ai_sw_trollface"),
	"SW Unsure"					= new /datum/ai_emotion("ai_sw_unsure"),
	"SW Very Happy"				= new /datum/ai_emotion("ai_sw_veryhappy"),
	"Nightmare"					= new /datum/ai_emotion("ai_nmm")
	)
