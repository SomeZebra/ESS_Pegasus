...
/mob/living/silicon/ai/proc/pick_icon()
	...
	else icontype = input("Select an icon!", "AI", null, null) in list("Monochrome", "Rainbow", "Blue", "Inverted", "Text", "Smiley", "Angry", "Dorf", "Matrix", "Bliss", "Firewall", "Green", "Red", "Static", "Triumvirate", "Triumvirate Static", "Soviet", "Trapped", "Heartline", "Chatterbox", "Sweetie", "Nightmare")
	switch(icontype)
		...
		if("Sweetie") icon_state = "ai-sweetie"
		if("Nightmare") icon_state = "ai-nmm"
		else icon_state = "ai"
	//else
