...
/obj/structure/closet/wardrobe/chaplain_black/New()
	...
	new /obj/item/clothing/suit/poncho/red(src)
	new /obj/item/clothing/suit/poncho/green(src)
	new /obj/item/clothing/suit/poncho/blue(src)
	new /obj/item/clothing/suit/poncho/purple(src)
	return
