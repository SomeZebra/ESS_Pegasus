...
//Classic
/obj/item/clothing/head/helmet/classic
	name = "classic helmet"
	desc = "Vintage helmet for true warriors. Completely covers the eyes."
	icon_state = "classic_helm"
	flags = HEADCOVERSEYES
	armor = list(melee = 75, bullet = 75, laser = 10,energy = 10, bomb = 75, bio = 2, rad = 0)
	flags_inv = HIDEEARS|HIDEEYES